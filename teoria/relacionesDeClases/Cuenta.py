...
class Cuenta:
    ...
    def __init__(self, saldo_inicial: float, tipo_de_cuenta: str, nombre_propietario: str):
        ...
        self.__propietario_cuenta = nombre_propietario # Renombrado para claridad

    def imprimir_detalles_cuenta(self):
        """
        Muestra los detalles de la cuenta en la consola.
        """
        # print("\n--- Detalles de la Cuenta ---") # Se comenta para evitar doble titulo si se llama desde Cliente
        print(f"Propietario: {self.__propietario_cuenta}")
